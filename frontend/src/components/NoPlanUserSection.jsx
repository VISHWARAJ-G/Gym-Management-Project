  ...
  return (
    <>
      <div className="flex justify-center">
        <div className="bg-white hover:shadow-[2px_2px_20px_rgb(0,0,0,0.5)] flex justify-center items-center w-3/4 my-8 py-9">
          <div className="flex flex-col items-center">
            ...
            <div>
              <h1 className="font-bold text-xl tracking-wider my-2">
                No Active Plan
              </h1>
            </div>
            <div>
            ...
            <div>
              <button
                onClick={moveFunc}
                className="bg-gradient-to-r from-yellow-400 to-orange-600 px-5 py-2 mt-4 rounded-xl font-semibold"
              >
                Choose a Plan
              </button>
            </div>
